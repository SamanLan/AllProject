...
public class Main2Activity extends AppCompatActivity {
    ...
    private class TestAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return viewType == 1 ? new AlphaHolder(LayoutInflater.from(Main2Activity.this).inflate(R.layout.alpha_itam, parent, false)) :
                    new NormalHolder(LayoutInflater.from(Main2Activity.this).inflate(R.layout.normal_item, parent, false));
        }
